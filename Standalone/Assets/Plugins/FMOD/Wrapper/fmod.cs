...
#endif
		public const int    number = 0x00010308;
    }
...
#pragma warning restore 414
    ...
    */
    public class System : HandleBase
    {
        ...
        {
            return FMOD_System_SetCallback(rawPtr, callback);
        }
        ...
        */
        ...
        public RESULT playDSP                (DSP dsp, bool paused, out Channel channel)
        {
            ...
            IntPtr channelraw;
            RESULT result = FMOD_System_PlayDSP(rawPtr, dsp.getRaw(), paused, out channelraw);
            channel = new Channel(channelraw);
        ...
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_System_PlayDSP                (IntPtr system, IntPtr dsp, bool paused, out IntPtr channel);
        [DllImport(VERSION.dll)]
    ...
    */
    public class Sound : HandleBase
    {
        ...
        {
            return FMOD_Sound_SetDefaults(rawPtr, frequency, volume, pan, priority);
        }
        public RESULT getDefaults             (out float frequency, out float volume, out float pan, out int priority)
        {
            return FMOD_Sound_GetDefaults(rawPtr, out frequency, out volume, out pan, out priority);
        }
